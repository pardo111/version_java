...
import clinica.version_java.modules.personas.repositories.AntecedentesFamiliaresRepository;
import clinica.version_java.modules.personas.repositories.ContactoEmergenciaRepository;
...
import clinica.version_java.modules.personas.services.interfaces.AntecedentesFamiliaresService;
...
import clinica.version_java.modules.personas.services.interfaces.PersonaService;
        ...
        try {
            ...
            if (personaRepository.existsByDui(persona.getDui())) {
                ...
                personaGuardada = personaRepository.findByDui(persona.getDui())
                        .orElseThrow(() -> new Exception("persona no existe"));
            ...
            e.printStackTrace();
            throw new Exception("Error al crear la persona completa" + e.getMessage());
        }
