...
public class CorreoPersonaController {
    ...
    public ResponseEntity<?> actualizarCorreo(@RequestBody Map<String, String> body) throws Exception {
    ...
    public ResponseEntity<?> borrarCorreo(@RequestBody Map<String, String> body) throws Exception {
        int idPersona = Integer.parseInt(body.get("idPersona"));
        String correoAntiguo = body.get("correoAntiguo");
    ...
    public ResponseEntity<?> agregarCorreo(@RequestBody Map<String, String> body) throws Exception {
